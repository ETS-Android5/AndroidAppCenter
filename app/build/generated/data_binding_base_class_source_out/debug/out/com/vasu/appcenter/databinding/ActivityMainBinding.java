...
import com.example.latest.vasu.newappcenter.widgets.TopsMoreAppsView;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final Button showMoreApp;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull SwitchCompat adsSwitch,
      @NonNull AllScreenHeaderBinding layoutHeader, @NonNull TopsMoreAppsView moreAppView,
      @NonNull SwitchCompat openAdsSwitch, @NonNull Button showDialogs,
      @NonNull Button showFullScreenNativeAd, @NonNull Button showInterstitialAds,
      @NonNull Button showMoreApp, @NonNull Button showNativeAds,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.show_more_app;
      Button showMoreApp = ViewBindings.findChildViewById(rootView, id);
      if (showMoreApp == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, adsSwitch, binding_layoutHeader,
          moreAppView, openAdsSwitch, showDialogs, showFullScreenNativeAd, showInterstitialAds,
          showMoreApp, showNativeAds, showRewardInterstitialAds, showRewardVideoAds,
